...
echo "   2. Direct domain: /home/ta-cukrarna/scripts/setup-virtualhost.sh"
echo "      (Note: Keeps your existing default site configuration)"
echo ""
echo "🧹 Optional tasks:"
echo "   • Fix UserDir config: /home/ta-cukrarna/scripts/fix-userdir.sh"
echo "   • Remove Node.js: /home/ta-cukrarna/scripts/remove-nodejs.sh"
